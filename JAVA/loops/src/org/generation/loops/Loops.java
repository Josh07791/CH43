...
public class Loops {
	public static void main(String[] args) {
		...
		// 1. Crea un programa que realice una cuenta de 1 a n, donde n es el numero que el usuario proporciona
		Scanner scanner = new Scanner(System.in);
		System.out.println("Ingresa un número final");
		
		// Podemos inicializar multiples variables del mismo tio en una sola linea
